 ...
 * @description 创建
 */
namespace idescript\package\wechart\pay\v3\aop\PayTransactionsJsapi;
class Request{

    // https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter3_1_1.shtml

    // 网关
    protected $uri = "https://api.mch.weixin.qq.com/v3/pay/transactions/jsapi";
    ...
    public function request_params(array $params){
    ...
    public function callback($query, \idescript\package\wechart\pay\v3\aop\AopClient $aop){
        ...
        $package['package'] = "prepay_id=".$query->prepay_id;
