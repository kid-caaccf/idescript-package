 ...
 * @description 创建
 */
namespace idescript\package\socket\client;

class Websocket{

    public static function instance(): Websocket{
    ...
    public function connect($host, $port, $path, $origin = false,$timeout=5)
    {
        $this->_host = $host;
        $this->_port = $port;
        $this->_path = $path;
        ...
        socket_set_timeout($this->_Socket, $timeout, 10000);
